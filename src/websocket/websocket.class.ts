...
import { MockPlaceWebsocketModule } from './mock/mock-engine-module.class';
import { MockPlaceWebsocketSystem } from './mock/mock-engine-system.class';
import { mockSystem } from './mock/mock-system-register.class';
import {
    PlaceCommandRequest,
...
export function bind(
    ...
    const request: PlaceCommandRequest = { id: ++REQUEST_COUNT, cmd: 'bind', ...options };
    return post(request);
}
...
export function unbind(
    ...
    const request: PlaceCommandRequest = { id: ++REQUEST_COUNT, cmd: 'unbind', ...options };
    return post(request);
}
...
export function execute<T = any>(
    ...
    const request: PlaceCommandRequest = { id: ++REQUEST_COUNT, cmd: 'exec', ...options };
    return post(request);
}
...
export function debug(
    ...
    const request: PlaceCommandRequest = { id: ++REQUEST_COUNT, cmd: 'debug', ...options };
    return post(request);
}
...
export function ignore(
    ...
    const request: PlaceCommandRequest = { id: ++REQUEST_COUNT, cmd: 'ignore', ...options };
    return post(request);
}
