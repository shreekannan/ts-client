...
describe('Repositorys API', () => {
    it('should allow querying repositorys', async () => {
        ...
        const list = await SERVICE.queryRepositories().toPromise();
    ...
    it('should allow creating new repositorys', async () => {
        ...
        spy.mockImplementation((_, _1, process: any, _2) => of(process({}) as any));
        const item = await SERVICE.addRepository({}).toPromise();
        expect(item).toBeInstanceOf(PlaceRepository);
    });
    ...
    it('should allow updating repository details', async () => {
        ...
        const item = await SERVICE.updateRepository('1', {}).toPromise();
        expect(item).toBeInstanceOf(PlaceRepository);
    });
    ...
    it('should allow listing repository drivers', async () => {
        ...
        const item = await SERVICE.listRepositoryDrivers('1').toPromise();
